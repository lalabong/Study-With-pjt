export const ERROR_CODES = {
  ...
  AUTH_UNAUTHORIZED: 1401, // HTTP 상태 코드 반영
  AUTH_ACCESS_TOKEN_SECRET_MISSING: 1005,
  AUTH_REFRESH_SECRET_MISSING: 1006,
  AUTH_TOKEN_EXPIRED: 1007,
  AUTH_INVALID_TOKEN: 1008,
  AUTH_INVALID_REFRESH_TOKEN: 1009,
  AUTH_REFRESH_TOKEN_EXPIRED: 1010,
  AUTH_TOKEN_REQUIRED: 1011,
  AUTH_USER_NOT_FOUND: 1404,
  AUTH_INVALID_PASSWORD: 1012,
  ...
  // 사용자 관련 오류 (3000~3999)
  USER_NOT_FOUND: 3404,
  USER_INVALID_NICKNAME: 3001,
  USER_FILE_SIZE_TOO_LARGE: 3002,
  USER_INVALID_FILE_TYPE: 3003,
  USER_FILE_UPLOAD_ERROR: 3004,
  USER_UNAUTHORIZED: 3401,

  // 일정 관련 오류 (4000~4999)
  SCHEDULE_NOT_FOUND: 4404,
  SCHEDULE_PERMISSION_DENIED: 4403,
  SCHEDULE_INVALID_TIME_RANGE: 4422,
  SCHEDULE_REQUIRED_FIELDS: 4001,
  SCHEDULE_INVALID_ORDER_POSITION: 4422,
  SCHEDULE_DAILY_SCHEDULE_LIMIT: 4429,
};
